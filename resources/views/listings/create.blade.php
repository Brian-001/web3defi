...
<div class="flex items-center justify-center min-h-screen bg-slate-700">
    <form action="{{route('listings.store')}}" method="POST" class="shadow-lg bg-slate-700 p-6 rounded-lg w-full max-w-lg">
        ...
        <div class="mb-4 flex flex-col">
            ...
            <input type="text" name="listing_title" id="listing_title" value="{{old('listing_title')}}" class="bg-slate-600 font-semibold rounded-lg p-2" required>
            @error('listing_title')
        ...
        <div class="flex flex-wrap">
            ...
            <div class="mb-4 flex flex-col mr-4 w-full">
                ...
                <textarea name="company_description" id="company_description" cols="30" rows="5" value="{{old('company_description')}}" placeholder="Summarised information about the company" class="bg-slate-600 font-semibold rounded-lg h-32 resize-none p-2"></textarea>
            ...
            <div class="mb-4 flex flex-col w-full">
                ...
                <textarea name="job_description" id="job_description" cols="30" rows="5" value="{{old('job_description')}}" placeholder="Enter job description" class="bg-slate-600 font-semibold rounded-lg h-32 resize-none p-2"></textarea>
        ...
        <div class="flex flex-wrap">
            ...
            <div class="mb-4 flex flex-col mr-4 w-full">
                ...
                <textarea name="job_roles" id="job_roles" cols="30" rows="5" value={{old('job_roles')}} placeholder="Enter roles and responsibilities" class="bg-slate-600 font-semibold rounded-lg h-32 resize-none p-2"></textarea>
                @error('job_roles')
                    <span class="text-red-500 text-sm">{{$message}}</span>
                @enderror
            </div>
            ...
            <div class="mb-4 flex flex-col w-full">
                ...
                <textarea name="additional_info" id="additional_info" cols="30" rows="5" value={{old('additional_info')}} placeholder="More info about job e.g., Benefits, Holidays" class="bg-slate-600 font-semibold rounded-lg h-32 resize-none p-2"></textarea>
            ...
            <div class="flex flex-col">
                ...
                <div class="flex flex-col md:flex-row gap-4"> {{-- Changed to flex-col for small screens and flex-row for medium and larger screens --}}
                    ...
                    <div class="flex flex-col w-full"> {{-- Use w-full to ensure full width on small screens --}}
                        ...
                        <input type="number" name="min_salary" id="min_salary" min=0 value="{{old('min_salary')}}" class="bg-slate-600 font-semibold rounded-lg p-2" required>
                        @error('min_salary')
                            <span class="text-red-500 text-sm">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="flex flex-col w-full"> {{-- Use w-full to ensure full width on small screens --}}
                        ...
                        <input type="number" name="max_salary" min="0" id="max_salary" value="{{old('max_salary')}}" class="bg-slate-600 font-semibold rounded-lg p-2" required>
                        @error('max_salary')
                            <span class="text-red-500 text-sm">{{$message}}</span>
                        @enderror
                    </div>
        ...
        <div class="mb-4 flex flex-col">
            ...
            <input type="text" name="location" id="location" value="{{old('location')}}" placeholder="City, Country" class="bg-slate-600 font-semibold rounded-lg p-2">
            @error('location')
                <span class="text-red-500 text-sm">{{$message}}</span>
            @enderror
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="mb-4 flex flex-col">
                ...
                <select name="tags" id="tags" class="bg-slate-600 font-semibold rounded-lg p-2">
                    <option value="" class="text-gray-200" disabled>--Select a tag--</option>
            ...
            <div class="mb-4 flex flex-col">
                ...
                <select name= "job_type" id= "job_type" value="{{old('job_type')}}" class= "bg-slate-600 font-semibold rounded-lg p-2">
                    <option value="" class="text-gray-200" disabled>--Select Job Type--</option>
        ...
        <div class="mb-4 flex flex-col">
            ...
            <input type="file" name="listing_logo" id="listing_logo" class="file:px-2 file:py-1.5 file:border-none file:rounded-lg file:bg-slate-600
             file:text-white file:cursor-pointer rounded-md shadow-sm outline-none border-none file:outline-none shadow-cyan-300" accept="image/*">
        </div> 
        <div>
