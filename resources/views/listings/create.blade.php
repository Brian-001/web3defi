...
<div class="container mx-auto px-4 py-8">
    <div class="bg-white p-6 rounded-xl shadow-lg">
        ...
        <div class="flex items-center justify-between mb-6">
            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Create Job Listing</h1>
        ...
        <form action="{{ route('listings.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    ...
                    <input type="text" name="listing_title" id="listing_title" value="{{ old('listing_title') }}" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    ...
                    <textarea name="company_description" id="company_description" rows="4" 
                              ...
                              class="w-full p-2 text-sm text-gray-700 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 resize-none">{{ old('company_description') }}</textarea>
                ...
                <div class="space-y-2">
                    ...
                    <textarea name="job_description" id="job_description" rows="4" 
                              ...
                              class="w-full p-2 text-sm text-gray-700 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 resize-none" required>{{ old('job_description') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    ...
                    <textarea name="job_roles" id="job_roles" rows="4" 
                              ...
                              class="w-full p-2 text-sm text-gray-700 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 resize-none" required>{{ old('job_roles') }}</textarea>
                    @error('job_roles')
                        <span class="text-red-500 text-xs">{{ $message }}</span>
                    @enderror
                </div>
                <div class="space-y-2">
                    ...
                    <textarea name="additional_info" id="additional_info" rows="4" 
                              ...
                              class="w-full p-2 text-sm text-gray-700 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500 resize-none">{{ old('additional_info') }}</textarea>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <select name="job_type" id="job_type" 
                        ...
                        <option value="onsite" {{ old('job_type') === 'onsite' ? 'selected' : '' }}>On-site</option>
            ...
            <div class="space-y-2">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="number" name="min_salary" id="min_salary" min="0" value="{{ old('min_salary') }}" 
                               class="w-full p-2 text-sm text-gray-700 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500" required>
                        @error('min_salary')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="max_salary" id="max_salary" min="0" value="{{ old('max_salary') }}" 
                               class="w-full p-2 text-sm text-gray-700 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500" required>
                        @error('max_salary')
                            <span class="text-red-500 text-xs">{{ $message }}</span>
                        @enderror
