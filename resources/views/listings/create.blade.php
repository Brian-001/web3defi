    ...
    <div class="p-6 rounded-lg shadow-lg w-full md:w-1/2 mt-10 md:mx-auto h-full">
        <form action="{{route('listings.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="flex items-center justify-between mb-10">
                <div>
                    <h1 class="text-lg text-cyan-300 mb-4 place-items-center">Create a new job</h1>
                </div>
                <div class="flex">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-0 md:mb-10">
                ...
                <div class="mb-4 flex flex-col">
                    <label for="listing_title" class="font-semibold text-white mb-2">Job Title <span class="text-sm text-red-500">*</span></label>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-0 md:mb-10">
                ...
                <div class="mb-4 flex flex-col w-full">
                    <label for="job_description" class="font-semibold text-white mb-2">Job Description<span class="text-sm text-red-500">*</span></label>
