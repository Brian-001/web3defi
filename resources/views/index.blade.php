...
<div class="grid grid-cols-12 gap-2 max-w-7xl mx-auto mt-10">
    ...
    <div class="col-span-12 md:col-span-7 row-span-6 shadow-lg rounded-md relative">
        ...
        <div class="absolute inset-0 bg-gradient-to-b from-transparent to-slate-900/90 flex flex-col justify-center">
            ...
            <p class="p-4 text-sm md:text-base tracking-wider text-white">
...
<div class="col-span-12 mt-10">
    <div class="flex justify-center mb-4">
        <input type="text" placeholder="Search..." class="search-bar text-white font-semibold tracking-wide md:w-1/2 p-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-cyan-300 bg-slate-600">
    </div>
